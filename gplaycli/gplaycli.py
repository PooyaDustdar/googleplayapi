...
class GPlaycli:
    ...
    @hooks.connected
    def download(self, pkg_todownload, details=list()):
        success_downloads = []
        failed_downloads = []
        unavail_downloads = []
    ...
    @hooks.connected
    def search(self, search_string, nb_results):
        try:
    ...
    def details(self, package_name):
        results = self.api.details(package_name)
        return results
